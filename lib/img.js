...
function Img(props) {
    ...
    return (React.createElement(react_deco_1.Bare, { constructor: constructor, didMount: function (cmp) { return didMount(cmp, props); }, willUnmount: willUnmount, render: function (cmp) {
            return React.createElement("div", __assign({}, wrapperProps, { "data-wrapper": true, style: __assign({}, wrapperStyle, wrapperProps.style), ref: function (ref) { return attachWrapperElRef(cmp, props, ref); } }),
                ...
                React.createElement("div", { key: 'preserver', style: {
                        paddingBottom: (getPreserverPaddingBottom(Number(props.aspectRatio)) ||
...
function beginImgLoad(cmp, props) {
    if (props.placeholderSrc) {
        loadImg(props.placeholderSrc, function (img) {
            cmp.setState({
    ...
    loadImg(props.src, function (img) {
        cmp.setState({
            loaded: true,
            aspectRatio: getImageAspectRatio(img)
        });
...
function getPreserverPaddingBottom(aspectRatio) {
    var ar = Number(aspectRatio);
    return isNaN(ar) ? 0 : aspectRatio * 100 + '%';
}
function loadImg(src, onLoad) {
    var img = new Image();
    img.onload = function () { return onLoad(img); };
    img.src = src;
}
